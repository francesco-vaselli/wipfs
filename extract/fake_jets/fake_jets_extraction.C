...
void jets_extraction() {
  ...
  */
  ...
  // Print column type
  std::cout << "Column JetMask"
            << " has type " << colType1 << std::endl;
  ...
  auto d_matched =
      d_def.Define("MGenJet_eta", "Take(GenJet_eta,MatchedGenJets)")
          ...
          .Define("MGenJet_partonFlavour",
                  "Take(GenJet_partonFlavour,MatchedGenJets)")
          .Define("MGenJet_hadronFlavour",
                  "Take(GenJet_hadronFlavour,MatchedGenJets)")
          .Define("MMuon_pt", "GenPart_pt[MuonMask]")
          .Define("MMuon_eta", "GenPart_eta[MuonMask]")
          .Define("MMuon_phi", "GenPart_phi[MuonMask]")
          .Define("MClosestMuon_dr", closest_muon_dr,
                  {"MGenJet_eta", "MGenJet_phi", "MMuon_eta", "MMuon_phi"})
          .Define("MClosestMuon_deta", closest_muon_deta,
                  {"MGenJet_eta", "MGenJet_phi", "MMuon_eta", "MMuon_phi"})
          .Define("MClosestMuon_dphi", closest_muon_dphi,
                  {"MGenJet_eta", "MGenJet_phi", "MMuon_eta", "MMuon_phi"})
          .Define("MClosestMuon_pt", closest_muon_pt,
                  {"MGenJet_eta", "MGenJet_phi", "MMuon_eta", "MMuon_phi",
                   "MMuon_pt"})
          .Define("MSecondClosestMuon_dr", second_muon_dr,
                  {"MGenJet_eta", "MGenJet_phi", "MMuon_eta", "MMuon_phi"})
          .Define("MSecondClosestMuon_deta", second_muon_deta,
                  {"MGenJet_eta", "MGenJet_phi", "MMuon_eta", "MMuon_phi"})
          .Define("MSecondClosestMuon_dphi", second_muon_dphi,
                  {"MGenJet_eta", "MGenJet_phi", "MMuon_eta", "MMuon_phi"})
          .Define("MSecondClosestMuon_pt", second_muon_pt,
                  {"MGenJet_eta", "MGenJet_phi", "MMuon_eta", "MMuon_phi",
                   "MMuon_pt"})
          ...
          .Define("MJet_phiMinusGen", DeltaPhi,
                  {"MJet_phifiltered", "MGenJet_phi"})
          .Define("MJet_ptRatio", "Jet_pt[JetMask]/MGenJet_pt")
          .Define("MJet_puId", "Jet_puId[JetMask]")
          //.Define("MJet_hfadjacentEtaStripsSize",
          //"Jet_hfadjacentEtaStripsSize[JetMask]")
          //.Define("MJet_hfcentralEtaStripSize",
          //"Jet_hfcentralEtaStripSize[JetMask]") .Define("MJet_puIdDisc",
          //"Jet_puIdDisc[JetMask]")
  ...
  vector<string> col_to_save = {"MClosestMuon_dr",
                                "MClosestMuon_pt",
                                "MClosestMuon_deta",
                                "MClosestMuon_dphi",
