...
void prova() {
  ...
  auto gen_pt = full_dy.Take<ROOT::VecOps::RVec<float>, ROOT::VecOps::RVec<float>>("MGenElectron_pt");

  auto reco_pt = synth_dy.Take<ROOT::VecOps::RVec<float>, ROOT::VecOps::RVec<float>>("Electron_pt");
