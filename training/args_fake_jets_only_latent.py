...
def add_args(parser):
    ...
    latent_flow_param_dict = {
            "input_dim" : Z_DIM,
            "context_dim" : Y_DIM,
            "num_flow_steps" : 2, # increasing this could improve conditioning

            "base_transform_kwargs" : {
            "num_transform_blocks": 10, # DNN layers per coupling
            "activation": "elu",
    ...
    parser.add_argument('--lr_reco', type=float, default=1e-4,
                        help='Reconstruction learning rate for the Adam optimizer.')
    ...
    # resuming
    parser.add_argument('--resume_latent_checkpoint', type=str, default=None,
